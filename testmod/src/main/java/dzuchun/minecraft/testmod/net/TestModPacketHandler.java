...
public class TestModPacketHandler {
	...
	public static void init() {
		INSTANCE.registerMessage(35, LeapMessage.class, LeapMessage::encode, LeapMessage::decode, TestModPacketHandler::leapMessageHandler, Optional.of(NetworkDirection.PLAY_TO_SERVER));
	}
