...
public class TestChunkGenerator extends NoiseChunkGenerator<TestGenSettings>{
	...
	public TestChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, TestGenSettings settingsIn) {
		super(worldIn, biomeProviderIn, 4, 8, 256, settingsIn, true);
