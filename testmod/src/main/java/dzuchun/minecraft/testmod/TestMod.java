...
import dzuchun.minecraft.testmod.world.dimension.TestDimension;
...
public class TestMod
{
    ...
    public static EntityType<BarkingBucketEntity> BARKING_BUCKET_ENTITY_TYPE = EntityType.Builder.<BarkingBucketEntity>create(BarkingBucketEntity::new, EntityClassification.CREATURE)
    ...
    public TestMod() 
    {
    	...
    	final RegistryObject<Block> TEST_BLOCK_REGISTRY_OBJECT = BLOCKS.register("test_block", () -> TEST_BLOCK_BLOCK_ITEM.getBlock());
    	@SuppressWarnings("unused")
    	...
    	@SuppressWarnings("unused")
    	final RegistryObject<Item> TEST_BLOCK_ITEM_REGISTRY_OBJECT = ITEMS.register("test_block", () -> TEST_BLOCK_BLOCK_ITEM.asItem());
    	@SuppressWarnings("unused")
    	final RegistryObject<Item> TEST_CHESTPLATE_REGISTRY_OBJECT = ITEMS.register("test_chestplate", () -> TEST_CHESTPLATE);
    	@SuppressWarnings("unused")
    	...
    	final DeferredRegister<TileEntityType<?>> TILE_ENTITIES = new DeferredRegister<>(ForgeRegistries.TILE_ENTITIES, MODID);
        //Adding TE to register
    	LOGGER.info("Adding TE to register");
    	ANIMATION_BLOCK_ENTITY_TYPE_REGISTRY_OBJECT = TILE_ENTITIES
    		.register("animation_block",
    				() -> TileEntityType.Builder.create(AnimationBlockEntity::new, new Block[] {TestMod.ANIMATION_BLOCK}).build(null));
    	TEST_TILE_ENTITY_REGISTRY_OBJECT = TILE_ENTITIES
        		.register("test_block",
        				() -> TileEntityType.Builder.create(TestTileEntity::new, new Block[] {TestMod.TEST_BLOCK}).build(null));
    	
    	//Creating container type registry
    	final DeferredRegister<ContainerType<?>> CONTAINER_TYPES = new DeferredRegister<>(ForgeRegistries.CONTAINERS, TestMod.MODID);
    	//Adding contaners to registry
    	TEST_CONTAINER_TYPE_REGISTRY_OBJECT = CONTAINER_TYPES.register("test_container", () -> IForgeContainerType.create(TestContainer::new));
    	
    	//Creating entity type registry
    	final DeferredRegister<EntityType<?>> ENTITY_TYPES = new DeferredRegister<EntityType<?>>(ForgeRegistries.ENTITIES, MODID);
    	...
    	BARKING_BUCKET_ENTITY_TYPE_REGISTRY_OBJECT = ENTITY_TYPES.register("barking_bucket_entity", () -> BARKING_BUCKET_ENTITY_TYPE
		);
//    	ForgeRegistries.ENTITIES.register(BARKING_BUCKET_ENTITY_TYPE);
    	
    	//Creating feature register
    	final DeferredRegister<Feature<? extends IFeatureConfig>> FEATURES = new DeferredRegister<Feature<? extends IFeatureConfig>>(ForgeRegistries.FEATURES, MODID);
    	//Adding features to register
    	TEST_STRUCTURE_REGISTRY_OBJECT = FEATURES.register("test_structure", () -> new TestStructure(NoFeatureConfig::deserialize));
...
//    	ForgeRegistries.FEATURES.register(PINEAPPLE_TREE_FEATURE.setRegistryName(MODID, "pineapple_tree"));
    	...
    	TEST_STRUCTURE_PIECE = Registry.register(Registry.STRUCTURE_PIECE, TEST_STRUCTURE_PIECE_LOCATION, TestStructurePiece::new);
    	...
    	final DeferredRegister<ModDimension> DIMENSIONS = new DeferredRegister<ModDimension>(ForgeRegistries.MOD_DIMENSIONS, MODID);
		...
		dzuchun.minecraft.testmod.Entity.init();
    }
	...
	public static void clientSetup(final FMLClientSetupEvent event)
    {
		...
		RenderingRegistry.registerEntityRenderingHandler(PROFESSOR_ENTITY_TYPE_REGISTRY_OBJECT.get(), ProfessorRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(BARKING_BUCKET_ENTITY_TYPE_REGISTRY_OBJECT.get(), BarkingBuckerRenderer::new);
