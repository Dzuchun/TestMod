...
final class ServerConfig {
	...
	ServerConfig(final ForgeConfigSpec.Builder builder) {
		...
		electricFurnaceEnergySmeltCostPerTick = builder
				...
				.translation(TestMod.MODID + ".config.electricFurnaceEnergySmeltCostPerTick")
		...
		heatCollectorTransferAmountPerTick = builder
				...
				.translation(TestMod.MODID + ".config.heatCollectorTransferAmountPerTick")
